var go = function (settings) {
  ...
  var routes = boltroutes.generate('auto', settings.projectdir, settings.basedir, settings.config, settings.bundler, settings.testfiles, settings.stopOnFailure, basePage, settings.coverage);
