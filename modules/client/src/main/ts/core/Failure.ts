...
import { TestLabel } from '../api/TestLabel';
import * as TestLogs from '../api/TestLogs';
...
export const prepFailure = (err: TestThrowable, logs: TestLogs = TestLogs.init()): LoggedError => {
